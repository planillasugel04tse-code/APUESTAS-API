...
<title>Telegram Test · {PRODUCT_NAME}</title>
...
<body><main>
<div class="card"><h1>📩 Prueba Telegram · {PRODUCT_NAME}</h1><p class="muted">Prueba el pipeline Telegram → parser → matching → Analyzer/Radar/Surebet sin subir credenciales.</p>
