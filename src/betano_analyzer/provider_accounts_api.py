...
class ProviderAccountInput(BaseModel):
    provider:str="oddspapi"; label:str=Field(default="",max_length=100); email:str=Field(default="",max_length=200); api_key:str=Field(default="",max_length=500); account_id:str|None=Field(default=None,max_length=100); base_url:str|None=Field(default=None,max_length=500); auth_location:str=Field(default="query",pattern="^(query|header)$"); auth_name:str=Field(default="apiKey",max_length=100); test_path:str=Field(default="/account",max_length=200)
