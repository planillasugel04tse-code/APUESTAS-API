...
def surebet_page() -> HTMLResponse:
    ...
    return HTMLResponse(base+f'<style>{_CSS}</style></head><body><header><h1>💰 SUREBET</h1><p>Centro de oportunidades · PRE-MATCH y LIVE</p></header><main>{_base_nav()}{_CARD}</main><script>{_JS}</script></body></html>')
